...
# The story
print("\n--- Thomas' Mad Lib Story ---\n")
print(f"Meet Thomas, a {adj1} second-year Computer engineering student.")
print(f"He spends his days juggling {noun1}, solving math problems, and writing code that once {verb_past} an entire program.")
print(f"When he's not debugging, he's playing chess, watching the Leafs, or feeling incredibly {emotion} about a close game of {game}.")
print(f"His favorite snack after a long study session is {food}, preferably shared with friends at {place}.")
print(f"On weekends, you’ll find him lifting weights while listening to an {adj2} playlist, or anime.")
print(f"One day, Thomas hopes to build a tech tool so helpful that even {celebrity} would use it.")
...
# print("\n--- Thomas' Mad Lib Story ---\n")
# print("Meet Thomas, a " + adj1 + " second-year Computer Engineering student.")
# print("He spends his days juggling " + noun1 + ", solving math problems, and writing code that once " + verb_past + " an entire program.")
# print("When he's not debugging, he's playing chess, watching the Leafs, or feeling incredibly " + emotion + " about a close game of " + game + ".")
# print("His favorite snack after a long study session is " + food + ", preferably shared with friends at " + place + ".")
# print("On weekends, you’ll find him lifting weights while listening to an " + adj2 + " playlist, or binge-watching anime.")
# print("One day, Thomas hopes to build a tech tool so helpful that even " + celebrity + " would use it.")
